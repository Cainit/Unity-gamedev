...
namespace Main
{
    class Program
    {
        ...
        {
            Console.Title = "Unity gamedev - Homework 4 - Dolgov K.";
            ...
            do
            {
                ...
                Console.Clear();
                Helper.PrintHomeWork(4, "Долгов Константин");

                //Вывод программного меню
                PrintMenu();

                //Выбор решаемой задачи
                taskNumber = Helper.WaitNumber("Введите номер задачи или введите \"0\" для выхода:");
                switch (taskNumber)
                {
        ...
        static void PrintMenu()
        {
            ...
            Helper.PrintProgrammInfo("1 -> Задача 1. Класс для работы с массивом.");
            Helper.PrintProgrammInfo("2 -> Задача 2. Логины и пароли.");
